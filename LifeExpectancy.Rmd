...
```{r sample block, fig.height=6.5,fig.width=7, warning=FALSE, message=FALSE, cache=TRUE,dev="png", dpi=100,cache=TRUE,results='markup'}
...
Housing: House density, vacant building density

Food Environment: Nearest distance to food store/supermarket/grocery

Health and Well-Being: Nearest distance to nursing home/shelter
